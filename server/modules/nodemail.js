...
let nodemailerPeon = {
  sendEmail: async (to, subject, message) => {
    ...
    for ( let i = 0; i < message.bullwhips.length; i ++){
      ...
      message.bullwhips[i].type + ' ' + i + '<br/>' +
      'Color 1: ' + message.bullwhips[i].item.color1.name + '<br/>' +
      'Color 2: ' + message.bullwhips[i].item.color2.name + '<br/>' +
      'Waxed: ' + message.bullwhips[i].item.waxed + '<br/>' +
      'Handle Pattern: ' + message.bullwhips[i].item.pattern.name + '<br/>' +
      'Whip Length: ' + message.bullwhips[i].item.whipLength.name + ' feet <br/>' +
      'Handle Length: ' + message.bullwhips[i].item.handleLength.name + ' inches <br/>' +
      'Concho: ' + message.bullwhips[i].item.concho.name + '<br/>' +
      'Item Cost: $' + message.bullwhips[i].item.total + '<br/>' 
    }
    ...
    ${message.order.shipping_city}, ${message.order.shipping_state}, ${message.order.shipping_country}, ${message.order.shipping_zip} <br/>
